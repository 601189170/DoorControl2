package com.yyide.doorcontrol.hongruan.util.camera;
...
public class CameraHelper implements Camera.PreviewCallback {
    ...
    int cameraDegress;//拿到相机相机选旋转的角度
    ...
    private CameraHelper(Builder builder) {
        ...
        setmCameraId = builder.setmCameraId;
...
//            mCameraId = Camera.getNumberOfCameras() - 1;
            mCameraId=0;
            int  sum=Camera.getNumberOfCameras();
            Log.e(TAG, "getNumberOfCameras: " +sum);
            if (setmCameraId==2){
                mCameraId=0;
            }else {
                mCameraId = Camera.getNumberOfCameras() - 1;
...
//                parameters.setPreviewSize(640,480);
    ...
    private int getCameraOri(int rotation) {
        ...
        cameraDegress=info.orientation;
        setCameraDegress(cameraDegress);
    ...
    public int getCameraDegress() {
        return cameraDegress;
    }

    public void setCameraDegress(int cameraDegress) {
        this.cameraDegress = cameraDegress;
    }
...
//            start();
    ...
    public static final class Builder {
        ...
        public Builder setCameraId(Integer val) {
            this.setmCameraId=val;
