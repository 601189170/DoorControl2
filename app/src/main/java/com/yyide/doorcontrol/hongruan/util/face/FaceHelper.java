package com.yyide.doorcontrol.hongruan.util.face;
...
import com.yyide.doorcontrol.hongruan.util.TrackUtil;
...
//                    Log.i(TAG, "onPreviewFrame: ft costTime = " + (System.currentTimeMillis() - ftStartTime) + "ms");
    ...
    public List<FacePreviewInfo> onPreviewFrameduo(byte[] nv21) {
        if (faceListener != null) {
            if (ftEngine != null) {
                faceInfoList.clear();
                long ftStartTime = System.currentTimeMillis();
