...
/**
 * 系统设置验证
 * R.layout.activity_door_cheack
 *  CardAppointmentSettingFragment()
 *   FaceAppointmentSettingFragment()
 * */

public class AppointmentSettingCheckActivity extends BaseActivity implements IdListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_identity6);
...
//                Intent intent3 = new Intent(this, EqpMentActivity.class);
